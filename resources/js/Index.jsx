                            ...
                            <div className="text-gray-800 dark:text-gray-200 flex flex-wrap py-4 border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[grey]">
                                            <span className="tags">Tag: {link.tag_name}</span> - <span>Added { link.source_date }</span> - <a href="#" onClick={(event) => toggleFavourites(event, link.source_link_id)}>{!link.favorited ? "Add to Favourites" : "Remove from Favourites"}</a>
                                        </p>
                                    </div>
                            </div>
                        </div>
